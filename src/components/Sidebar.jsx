    ...
    <div className="w-64 bg-[#141414] flex flex-col border-r" style={{ borderColor: colors.border }}>
          ...
          {[...defaultCommands, ...customCommands].map((item, index) => (
            <div key={item.name} className="group relative">
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2 hover:bg-[#202020] transition-colors text-gray-300 hover:text-white button-glow ${
      ...
      <div className="p-2 border-t" style={{ borderColor: colors.border }}>
        ...
        <div className="flex justify-between px-2 mt-2">
          <button 
            className={`p-1 hover:bg-[#202020] rounded button-glow ${isAddingCommand ? 'bg-[#202020]' : ''}`}
            onClick={() => {
          ...
          <button 
            className={`p-1 hover:bg-[#202020] rounded button-glow ${isSettingsOpen ? 'bg-[#202020]' : ''}`}
            onClick={() => {
          ...
          <button 
            className={`p-1 hover:bg-[#202020] rounded button-glow ${isRemoveMode ? 'bg-[#202020]' : ''}`}
            onClick={() => {
